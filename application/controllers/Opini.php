...
class Opini extends MX_Controller
{
    private $title;
	...
	public function berita($offset = 0)
    {
        ...
        $config['base_url'] = site_url('blog/berita/'.$category);
        $config['total_rows'] = $count;
        $config['per_page'] = $this->limit;
        $config['uri_segment'] = 3;
        $config['num_links'] = 5;
	...
	public function artikel($offset = 0)
    {
        ...
        $config['base_url'] = site_url('blog/artikel/'.$category);
        $config['total_rows'] = $count;
        $config['per_page'] = $this->limit;
        $config['uri_segment'] = 3;
        $config['num_links'] = 5;
	...
	public function informasi($offset = 0)
    {
        ...
        $config['base_url'] = site_url('blog/informasi/'.$category);
        $config['total_rows'] = $count;
        $config['per_page'] = $this->limit;
        $config['uri_segment'] = 3;
        $config['num_links'] = 5;
	...
	public function faq($offset = 0)
    {
        ...
        $config['base_url'] = site_url('blog/faq/'.$category);
        $config['total_rows'] = $count;
        $config['per_page'] = $this->limit;
        $config['uri_segment'] = 3;
        $config['num_links'] = 5;
