...
class Gallery extends MX_Controller
{
    ...
    public function index()
    {
        ...
        $template_data['judul'] = 'Media Library';
        $template_data['crumb'] = [
            'Media Library' => '',
        ];

        $this->output_view->set_wrapper('page', 'list', $data);
	...
	public function foto()
    {
        ...
        $data['media'] = $this->mediaModel->search(null, $lim);
        $data['count'] = $this->mediaModel->count() <= $lim;
        ...
        $this->output_view->set_wrapper('page', 'list_foto', $data);
        $this->output_view->output("template/front_template", $template_data);
    }
