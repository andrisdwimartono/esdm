			...
			<ol>
				...
				<li>In Add Page there's form : 
					<ul>
						...
						<li><strong>View</strong><br>View is list of view template that you created.</li>
					</ul>
				</li>
					...
					<ul>
						...
						<li>
							...
							<ul>
								...
								<li><strong>Add</strong> Checkbox for show or not field add.</li>
								<li><strong>Edit</strong> Checkbox for show or not field edit.</li>
								<li><strong>Details</strong> Checkbox for show or not field details.</li>
								<li><strong>Fields Type</strong> Select type field.</li>
								<li><strong>Validation</strong> Add validation rules.</li>
							</ul>
						</li>
					</ul>
				</li>
