 ...
 * Files Controller.
 */
class Aws3 extends MX_Controller
{
    private $title;
    ...
    {
        parent::__construct();
        $this->load->library(["output_view", "form_validation"]);
    ...
    public function demo()
    {
        ...
        if ($this->form_validation->run() == false) { // validation hasn't been passed
            $template_data['judul'] = 'Amazon Web Service S3 API';
            $template_data['crumb'] = [
                'Amazon Web Service S3' => '',
            ];

            $this->output_view->set_title('Aws3 API');
            $this->output_view->set_wrapper('page', 'aws3/upload', $data);
