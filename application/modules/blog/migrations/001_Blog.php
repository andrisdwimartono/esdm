...
class Migration_Blog extends CI_Migration
{
    ...
    public function up()
    {
        ...
        $data = [
            ['sort' => 5, 'level' => 2, 'parent_id' => 1, 'icon' => 'file-text-o', 'label' => 'Blog', 'link' => 'blog/manage', 'id' => '', 'id_menu_type' => 1],
            ['sort' => 6, 'level' => 2, 'parent_id' => 1, 'icon' => 'tag', 'label' => 'Category', 'link' => 'blog/category', 'id' => '', 'id_menu_type' => 1],
