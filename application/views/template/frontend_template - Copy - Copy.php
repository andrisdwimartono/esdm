					...
					<div class="container">			
						<div class="row">				
							<ul class="filters">					
								...
								<li data-filter=".informasi">Informasi</li>				
							</ul>			
						</div>		
					</div>				
					<div class="projects-container">					
					<div class="col-md-6 col-sm-12 no-pad project berita image-holder">				
						<div class="background-image-holder">					
							<img class="background-image" alt="Background Image" src="/esdm/assets/img/content/project1.jpg">				
						</div>				
						<div class="hover-state">					
							<div class="align-vertical">						
								<h1 class="text-white"><strong>Berita</strong> Satu</h1>						
								<p class="text-white">							Text & deskripsi dari<br>Berita.						</p>						
								<a href="/esdm/blog/read/berita-satu/1" class="btn btn-primary btn-white">Baca</a>					
							</div>				
						</div>			
					</div>						
					<div class="col-md-6 col-sm-12 no-pad project artikel image-holder">				
						<div class="background-image-holder">					
							<img class="background-image" alt="Background Image" src="/esdm/assets/img/content/project2.jpg">				
						</div>				
						<div class="hover-state">					
							<div class="align-vertical">						
								<h1 class="text-white"><strong>Artikel</strong> Satu</h1>						
								<p class="text-white">							Text & deskripsi dari<br>Artikel.						</p>
								<a href="/esdm/blog/read/berita-satu/1" class="btn btn-primary btn-white">Baca</a>					
							</div>				
						</div>			
					</div>						
					<div class="col-md-4 col-sm-6 no-pad project berita image-holder">				
						<div class="background-image-holder">					
							<img class="background-image" alt="Background Image" src="/esdm/assets/img/content/project3.jpg">				
						</div>				
						<div class="hover-state">					
							<div class="align-vertical">						
								<h1 class="text-white"><strong>Berita</strong> Dua</h1>						
								<p class="text-white">							Text & deskripsi dari<br>Berita.						</p>
								<a href="/esdm/blog/read/berita-satu/1" class="btn btn-primary btn-white">Baca</a>					
							</div>				
						</div>			</div>						<div class="col-md-4 col-sm-6 no-pad project informasi image-holder">				<div class="background-image-holder">					<img class="background-image" alt="Background Image" src="/esdm/assets/img/content/project4.jpg">				</div>				<div class="hover-state">					<div class="align-vertical">						<h1 class="text-white"><strong>Informasi</strong> Satu</h1>						<p class="text-white">							Text & deskripsi dari<br>Informasi.						</p>						<a href="/esdm/blog/read/berita-satu/1" class="btn btn-primary btn-white">Baca</a>					</div>				</div>			</div>						<div class="col-md-4 col-sm-6 no-pad project artikel image-holder">				<div class="background-image-holder">					<img class="background-image" alt="Background Image" src="/esdm/assets/img/content/project5.jpg">				</div>				<div class="hover-state">					<div class="align-vertical">						<h1 class="text-white"><strong>Artikel</strong> Dua</h1>						<p class="text-white">							Text & deskripsi dari<br>Artikel.						</p>						<a href="/esdm/blog/read/berita-satu/1" class="btn btn-primary btn-white">Read</a>					</div>				</div>			</div>				</div>	</div></section>
