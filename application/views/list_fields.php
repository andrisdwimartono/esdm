<?php foreach ($fields as $key => $value): ?>
	...
	<tr>
		...
		<td class="text-center">
			<?php if (is_array($Jfields)): ?>
				<input class="check check-config" <?php echo ($Jfields[$value->name]->actions->details != 1) ? '' : 'checked="checked"' ?> data-field = "<?php echo $value->name ?>" data-action="details" type="checkbox" checked="checked" name="table[<?php echo $value->name ?>][details]" value="1">
			<?php else: ?>				
