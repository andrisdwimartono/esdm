...
class Migration_Base extends CI_Migration
{
    ...
    public function up()
    {
        ...
        $data = [
            ...
            ['id_menu' => 4, 'sort' => 2, 'level' => 2, 'parent_id' => 1, 'icon' => 'table', 'label' => 'CRUD Builder', 'link' => 'myigniter/crud_builder', 'id' => '', 'id_menu_type' => 1],
            ...
            ['id_menu' => 21, 'sort' => 3, 'level' => 2, 'parent_id' => 1, 'icon' => 'file-o', 'label' => 'Page Builder', 'link' => 'myigniter/page_builder', 'id' => '', 'id_menu_type' => 1],
